...
const postCcavenueReadmissionResponseToPhp = async (
  ...
  try {
    ...
    console.log('===== CCAVENUE RESPONSE (READMISSION) =====');
    ...
    const phpResponse = await Api.sendCcavenueReadmissionResponse(payload);
    const phpBody = phpResponse?.data ?? phpResponse;

    console.log('===== PHP RESPONSE (READMISSION) =====');
    console.log(phpBody);
    console.log('=============================');
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      if (response.orderStatus === 'Success') {
        await postCcavenueReadmissionResponseToPhp(response);
